...
class Trainer(BaseTrainer):
    ...
    def log_predictions(
        ...
        **batch,
        ...
        # bs_text = self.text_encoder.ctc_decode_beamsearch_with_lm
        bs_text = self.text_encoder.ctc_decode_beamsearch(probs_cpu, beam_size, True, log_probs_length.numpy())
        bs_text = bs_text.numpy()
